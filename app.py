...
def get_recommendations(is_fresh, fruit_type):
    ...
    if is_fresh:
        recommendations = {
            'apple': "This fruit appears fresh. Store appropriately based on the fruit type.",
            'banana': "This fruit appears fresh. Store appropriately based on the fruit type.",
            'orange': "This fruit appears fresh. Store appropriately based on the fruit type."
        }.get(fruit_type, "This fruit appears fresh. Store appropriately based on the fruit type.")
    else:
        recommendations = {
            'apple': "This fruit appears spoiled. It's recommended to discard it to avoid potential health risks.",
            'banana': "This fruit appears spoiled. It's recommended to discard it to avoid potential health risks.",
            'orange': "This fruit appears spoiled. It's recommended to discard it to avoid potential health risks."
